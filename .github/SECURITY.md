...
please report it via [GitHub Security Advisories](https://github.com/BTreeMap/hass-cloudflared/security/advisories).
...
Please create a [new Security Advisory](https://github.com/BTreeMap/hass-cloudflared/security/advisories/new)
